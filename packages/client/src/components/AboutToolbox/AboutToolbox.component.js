      ...
      <div className="about-toolbox-full-page">
        ...
        <div className="about-toolbox-main-section">
          ...
          <div className="about-toolbox-text">
            ...
            organization and life. It doesn’t need special skills, you can use
            it today!
            <br />
            <br /> This Toolbox is a living thing and will keep growing over
            time. As we encounter and experience new tools and methods we will
            keep adding them. Do you know of something cool that we should
            include, or have a tool you’d like us to add to the Kaospilot
            Toolbox? Let us know!
            <br />
            ...
            credit we might have missed something. If we made a mistake or
            didn’t credit the correct source please write us.
            <br />
            <br /> Kaospilot is a disruptive educational provider and
            facilitator of learning experiences for individuals, communities and
            organizations which also offers consulting services. The Kaospilot
            methodology offers an alternative learning and pedagogical approach
            that is built around a rigorous training platform, which dynamically
            combines theory, action and reflection.{' '}
          </div>
        </div>
        <img
